...
<div class="max-w-3xl">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500 mt-1">Update teacher information and subject assignments</p>
    </div>
        ...
        <form action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <x-subject-selector :subjects="$subjects" :selected="$teacher->subjects->pluck('id')->toArray()" />
                </div>
